...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.0.47"), 12124)}, "C:\\Users\\Justin Olson\\Documents\\Fuse\\LootAbacus\\LootAbacus.unoproj", new string[] { })
{
